...
if __name__ == "__main__":
  try:
    ...
    for file_name in file_name_list:
      try:
        if train is True:
          file = open(signal_path + file_name + "_RN0_signal_train", "r")
        else:
          file = open(signal_path + file_name + "_RN0_signal_validation", "r")
        ...
        if train is True:
          file = open(signal_path + file_name + "_RN0_databit_train", "r")
        else:
          file = open(signal_path + file_name + "_RN0_databit_validation", "r")
        ...
        for idx in tqdm(range(n_signal), desc=file_name, ncols=100, unit=" signal"):
          ...
          for n in range(n_bit_data):
            ...
            type, score, shift, success = detect_bit(signal[idx][start-n_half_bit-n_tolerance_bit:end+n_half_bit+1], databit[idx][n], state)
